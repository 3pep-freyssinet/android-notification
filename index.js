...
app.get('/', (req, res) => {
    ...
    fs.readFile(filePath, 'utf8', (err, data) => {
        ...
        // Replace the placeholder with the environment variable
            //const updatedHtml = data.replace(/sitekey=\s*['"]?CLOUDFLARE_SITE_KEY['"]?/g,  `sitekey="${CLOUDFLARE_SITE_KEY}"`)          //note'='
	    const updatedHtml = data.replace(/sitekey:\s*['"]CLOUDFLARE_SITE_KEY['"]/, `sitekey: '${process.env.CLOUDFLARE_SITE_KEY}'`);  //note ':'
