...
router.get('/get-change-password-session-progress',   authMiddleware,   usersController.changePasswordSessionProgress);  // GET /users/get-change-password-session-progress
